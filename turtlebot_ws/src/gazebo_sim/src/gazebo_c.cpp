...
std::string yaml_file_path="/home/mali/snap/turtlebot_ws/src/gazebo_sim/config/rosparam.yaml";
std::string urdf_file_path="/home/mali/snap/turtlebot_ws/src/gazebo_sim/urdf/robot3.urdf.xacro";
